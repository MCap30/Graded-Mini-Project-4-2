...
> Use [`Sample Payslip.png`](Sample%20Payslip.png) (or [`Sample Payslip (No PII).png`](Sample%20Payslip%20%28No%20PII%29.png) for a version with no real personal data) to test the Read Payslip feature.
...
See [Phase1_IdeaValidation_PayslipAnalyzer.pdf](Phase1_IdeaValidation_PayslipAnalyzer.pdf) for the 7-step idea validation, [PRD.md](PRD.md) for the full product spec, and [spec.md](spec.md) for the technical spec and API contracts.
